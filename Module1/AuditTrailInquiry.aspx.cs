...
public partial class MedicalDevices_Audit_Trail_Inquiry : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (this.Page.IsPostBack.Equals(false))
        {
            ...
            LoadAuditTrailInquiry();
        }
    }
    public void LoadAuditTrailInquiry()
    {
        try
        {


            ds = _Security.GetAllAuditTrail();
            GVAuditTrail.DataSource = ds.Tables["AuditTrail"];
        ...
        catch (Exception ex)
        {
            ...
            _Security.ErrorModule = " Initializing Load Data in  AuditTrail Inquiry ";
            _Security.SaveError();
        }
    }
    ...
    protected void cpAuditTrailInquiry_Callback(object sender, CallbackEventArgsBase e)
    {
        try
        {
            this.LoadAuditTrailInquiry();
