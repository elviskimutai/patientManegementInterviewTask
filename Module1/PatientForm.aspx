<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PatientForm.aspx.cs" Inherits="Module1_PatientForm" %>
    ...
    <dx:ASPxMenu runat="server" EnableAdaptivity="True" CssClass="nav" ID="ASPxMenu4" EnableTheming="True" Font-Bold="True" ForeColor="Red" Theme="Metropolis">
        <Items>
            <dx:MenuItem Text="Get Funding" Name="Item1">
                <ItemStyle/>
                <Template>
                    <dx:ASPxLabel ID="lblCurrentPage" runat="server" Text="Patient Details" ForeColor="Blue">
                    </dx:ASPxLabel>
                </Template>
            </dx:MenuItem>
...
<BorderBottom BorderStyle="None"></BorderBottom>
                    ...
                    <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" GridViewID="GvPatientsDetails">
...
case &quot;mnuHelp&quot;:
		window.open(&quot;/WebHelp/PatientsDetails&quot;);
	break;
...
case &quot;mnuHelp&quot;:
		window.open(&quot;/WebHelp/PatientsDetails/index.htm&quot;);
	break;
	...
	break;
                ...
                <dx:TabPage Text="Next Of Kin">
                    <ContentCollection>
                        <dx:ContentControl runat="server">
                              <dx:ASPxCallbackPanel runat="server" ID="cpPatientsDetails" ClientInstanceName="cpPatientsDetails" OnCallback="cpPatientsDetails_Callback"  >
                                      <PanelCollection>
                                      <dx:PanelContent>
                            <dx:ASPxFormLayout ID="ASPxFormLayout5" runat="server" ColCount="2">
                                ...
                                <Items>
                                       <dx:LayoutItem Caption="DeptCode" Name="" RequiredMarkDisplayMode="Required">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridLookup ID="glDeptCode" runat="server" ClientInstanceName="glDeptCode" Theme="Metropolis" Width="170px">
                                                                    <gridviewproperties>
                                    ...
                                    <dx:LayoutItem Caption="PatientId" Name="txtPatientId" RequiredMarkDisplayMode="Required">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxTextBox ID="txtPatientId" runat="server" ClientInstanceName="txtPatientId" Width="170px" Theme="Metropolis">
       ...
       <dx:ASPxGridView runat="server" Width="100%" ID="GvPatientsDetails" ClientInstanceName="GvPatientsDetails" EnableRowsCache="False" EnableTheming="True" Theme="Metropolis" OnFillContextMenuItems="Grid_FillContextMenuItems"
        OnContextMenuItemClick="Grid_ContextMenuItemClick" KeyFieldName="PatientId;" >
	...
	GvPatientsDetails_RowClick(s, e);
...
OnContextMenuItemClick(s, e); 	
       ...
       <script src="../Scripts/jquery-3.1.0.min.js"></script>
        <script src="../Scripts/PatientDetails.js"></script>
